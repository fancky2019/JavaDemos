...
public class MqttMsgBacServer {
    ...
    private MqttMsgBacServer()
    {

    }
    private static class StaticInnerClass{
        private static final MqttMsgBacServer instance=new MqttMsgBacServer();
    }

    public static MqttMsgBacServer getInstance() {
        return MqttMsgBacServer.StaticInnerClass.instance;
    }
