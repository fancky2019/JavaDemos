...
public class MqttMsgBack {
    ...
    private static class StaticInnerClass {
        private static final MqttMsgBack instance = new MqttMsgBack();
    }

    public static MqttMsgBack getInstance() {
        return MqttMsgBack.StaticInnerClass.instance;
    }
...
//        TimerData.scheduledFutureMap.put(messageId, scheduledFuture);
    ...
    public void publish(ChannelHandlerContext context,String topic, String msg, MqttQoS qos, boolean retain) {
        MqttFixedHeader fixedHeader = new MqttFixedHeader(MqttMessageType.PUBLISH, false, qos, retain, 0);
        MqttPublishVariableHeader variableHeader = new MqttPublishVariableHeader(topic, getNewMessageId().messageId());
        ByteBuf byteBuf = ByteBufAllocator.DEFAULT.heapBuffer();//可自动扩容
